                                    ...
                                    @foreach ($peminjaman as $pinjam)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($pinjam->status == 'dipinjam')
                                                    <form action="/pinjam/{{ $pinjam->id }}/return" method="POST"
                                                        class="d-inline">
                                                        @csrf
                ...
                <form action="{{ route('pinjam.store') }}" method="POST">
                        ...
                        <select class="form-select @error('barang_id') is-invalid @enderror" id="barang_id" name="barang_id"
                            ...
                            @foreach ($barangs as $barang)
                                <option value="{{ $barang->id }}"
                                    ...
                                    {{ $barang->nama_barang }} (Stok: {{ $barang->stok }}) - {{ $barang->jenis ?? '-' }}
                                </option>
                            @endforeach
                        </select>
                        @error('barang_id')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('jumlah_pinjam') is-invalid @enderror"
                            id="jumlah_pinjam" name="jumlah_pinjam" value="{{ old('jumlah_pinjam') }}" required
                            min="1">
                        @error('jumlah_pinjam')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
