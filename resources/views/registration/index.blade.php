                ...
                <form action="/register" method="POST">
                    ...
                    <div class="form-floating">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            id="name" placeholder="Please entry your name" required value="{{ old('name') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                            id="username" placeholder="Please entry your Username" required value="{{ old('username') }}">
                    ...
                    <div class="form-floating">
                        <select class="form-control selectpicker @error('unit_bagian') is-invalid @enderror"
                            name="unit_bagian" id="unit_bagian" title="Pilih Unit Bagian" required>
